...
namespace eval ttk::theme::azure-dark {
    ...
    ttk::style theme create azure-dark -parent clam -settings {
        ...
        ttk::style layout Accent2.TButton {
            Accent2Button.button -children {
                Accent2Button.padding -children {
                    Accent2Button.label -side left -expand true
                }
            }
        }
        ...
        # Accent2Button
        ttk::style configure Accent2.TButton -padding {8 4 8 4} -width -10 -anchor center

        ttk::style element create Accent2Button.button image \
            [list $I(rect-accent2) \
            	{selected disabled} $I(rect-accent-hover) \
                disabled $I(rect-accent2) \
                pressed $I(rect-accent2) \
                selected $I(rect-accent2) \
                active $I(rect-accent2) \
                focus $I(rect-accent2) \
            ] -border 4 -sticky ewns
